...
matlab -batch "core_matlab('C5Tg4h', 'global_registration', '${i}', 3072, 34, 1, 3, 10, '/home/huzeng_pkuhpc/gpfs3/yly/20250101rj/alldata', '01_data', '02_registration', 'log', 'sqrt_pieces', 4)"
EOF
